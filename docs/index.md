# Privacy policy for Chrome extensions developed by bibineko
## Chrome拡張のプライバシーポリシー

本プライバシーポリシーは、bibineko（以下、「当開発者」）が開発したGoogleChromeの拡張機能(Extension)(以下、「拡張機能」とします。)の利用において、利用者の個人情報もしくはそれに準ずる情報を取り扱う際に、当開発者が遵守する方針を示したものです。
...
これにより、拡張機能の次回利用時に設定が維持され、利便性が向上します。
...
メールアドレス：tomofumi.oga@gmail.com
